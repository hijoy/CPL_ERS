<%@ Page Title="" Language="C#" MasterPageFile="~/DialogMasterPage.master" AutoEventWireup="true"
    CodeFile="POSearch.aspx.cs" Culture="auto" UICulture="auto" Inherits="Dialog_POSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsPO" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedPOViewByMAAID" EnablePaging="True" SelectCountMethod="QueryPOViewCountByMAAID"
        SortParameterName="sortExpression">
        <SelectParameters>
            <asp:Parameter Name="MAAID" Type="Int32" />
        </SelectParameters>
