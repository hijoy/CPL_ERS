<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganizationUnitSelectDlg.aspx.cs"
    Inherits="Dialog_OrganizationUnitSelectDlg" MasterPageFile="~/DialogMasterPage.master" Culture="auto" UICulture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTop" runat="Server">
<b><asp:Label ID="titleLabel" runat="server" meta:resourcekey="titleLabel" /></b>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        <div style="text-align: center;">
            <input id="OkBtn" class="button_nor" type="button" runat="server" onclick="dlgOk();" meta:resourcekey="button_OK"  />
            <input id="CancelBtn" class="button_nor" runat="server" type="button" onclick="dlgCancel();" value="<%$Resources:Common,Button_Cancel %>" />
        </div>
