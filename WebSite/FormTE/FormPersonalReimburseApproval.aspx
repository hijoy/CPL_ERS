<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FormPersonalReimburseApproval.aspx.cs" UICulture="Auto" Culture="Auto"
    Inherits="Form_FormPersonalReimburseApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="searchDiv">
        <table class="searchTable">
            <tr>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label3" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_ApplyDate" /></div>
                    <div>
            ...
            <tr>
                <td colspan="3" valign="top">
                    <div class="field_title">
                        <asp:Label ID="Label10" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_ApplyReason" /></div>
                    <div>
    ...
    <div runat="server" id="budgetDIV" class="searchDiv">
        <table class="searchTable">
            <tr>
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label11" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_TotalBudget" />
                    </div>
                    <div>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label12" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_ApprovingAmount" />
                    </div>
                    <div>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label13" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_ApprovedAmount" />
                    </div>
                    <div>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label14" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_RemainAmount" /></div>
                    <div>
    ...
    <br />
    <div class="title" style="width: 1240px">
        <asp:Label ID="Label15" runat="server" meta:resourcekey="FormPersonalReimburseApprove_Label_ReimburseDetails" /></div>
    <gc:GridView ID="gvPersonalReimburseDetails" runat="server" ShowFooter="True" CssClass="GridView"
        ...
        <Columns>
            ...
            <asp:TemplateField meta:resourcekey="PersonalReimburseDetailsGridView_TemplateField_RMB">
                <ItemTemplate>
                    <asp:Label ID="lblRMB" runat="server" Text='<%# Eval("RMB") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="150px" HorizontalAlign="Right" />
                <FooterTemplate>
    ...
    <asp:ObjectDataSource ID="odsPersonalReimburseDetails" runat="server" SelectMethod="GetFormPersonalReimburseDetailByFormPersonalReimburseID"
