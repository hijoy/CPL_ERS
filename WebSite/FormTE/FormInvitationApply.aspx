<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="FormInvitationApply.aspx.cs" Inherits="FormTE_FormInvitationApply"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function updateTotalRMB() {
            ...
            if (txtAmount.value && txtExchangeRate.value
            && (!isNaN(parseFloat(txtAmount.value)))
            && (!isNaN(parseFloat(txtExchangeRate.value)))) {
                var amount = parseFloat(txtAmount.value) * parseFloat(txtExchangeRate.value);
                txtAmountRMB.value = commafy(amount.toFixed(2));
                if (txtAttenderCount.value && (!isNaN(parseInt(txtAttenderCount.value)))) {
                    var count = parseInt(txtAttenderCount.value);
                    var avgCost = amount / count;
                    if (avgCost > 300) {
                        ...
                        <td style="width: 200px">
                            ...
                            <div>
                                <asp:DropDownList ID="dplPeriod" runat="server" DataSourceID="odsPeriod"
                                    DataTextField="PeriodReimburse" DataValueField="PeriodReimburseID" Width="180px">
                                </asp:DropDownList>
                ...
                <table>
                    ...
                    <tr>
                        <td style="width: 200px">
                            ...
                            <div>
                                <uc1:YearAndMonth ID="UCOccuredDate" runat="server" IsReadOnly="false" />
    ...
    <uc3:ucUpdateProgress ID="upUp1" runat="server" vassociatedupdatepanelid="upMain" />
</asp:Content>
