...
public partial class Form_FormPersonalReimburseApproval : BasePage {
    ...
    protected void EditBtn_Click(object sender, EventArgs e) {
        this.Response.Redirect("~/FormTE/FormPersonalReimburseApply.aspx?ObjectId=" + this.ViewState["ObjectId"].ToString() + "&RejectObjectID=" + this.ViewState["ObjectId"].ToString());
    }
    ...
    protected void ModifyPeriodBtn_Click(object sender, EventArgs e) {
        ...
        try {
            new FormTEBLL().ModifyPeriodForPersonalReimburse(int.Parse(this.ViewState["ObjectId"].ToString()),Period);
