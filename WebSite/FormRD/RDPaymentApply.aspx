<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RDPaymentApply.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormRD_RDPaymentApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <td style="width: 200px">
                    ...
                    <div>
                        <asp:DropDownList ID="PaymentTypeDDL" runat="server" AutoPostBack="true" Width="180px"
                            DataSourceID="sdsPaymentType" DataTextField="PaymentTypeName" DataValueField="PaymentTypeID"
            ...
            <gc:GridView ID="gvPaymentDetails" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_VendorName %>">
                        <ItemTemplate>
                            <uc4:UCVendor ID="UCVendor" runat="server" Width="180px" IsNoClear="true" VendorID='<%# Bind("VendorID") %>' IsLimited="true" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="Label_TaxAmount">
                        <ItemTemplate>
                            <asp:TextBox ID="txtTaxAmount" runat="server" Text='<%# Eval("TaxAmount") %>' Width="80px"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle Width="100px" HorizontalAlign="Right" />
                        <FooterTemplate>
    ...
    <asp:ObjectDataSource ID="odsPaymentDetails" runat="server" SelectMethod="GetFormRDPaymentDetail"
        TypeName="BusinessObjects.FormRDBLL" OnObjectCreated="odsPaymentDetails_OnObjectCreated">
    ...
    <asp:ObjectDataSource ID="odsInvoice" runat="server" DeleteMethod="DeleteFormInvoiceByID"
        SelectMethod="GetFormInvoice" TypeName="BusinessObjects.FormRDBLL" InsertMethod="AddFormInvoice"
