<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RDApply.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormRD_RDApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_ExpenseItem %>">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:SqlDataSource ID="sdsExpenseItem" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
                                SelectCommand="select ExpenseItemID,ExpenseItemName from ExpenseItem where ExpenseItem.ExpenseSubCategoryID = @ExpenseSubCategoryID order by ExpenseItemName">
                                <SelectParameters>
                    ...
                    <table class="FormView">
                        <tr>
                            <td style="width: 250px;" align="center">
                                <uc4:UCVendor ID="UCVendor" runat="server" Width="170px" IsNoClear="true" VendorID='<%# Bind("VendorID") %>' />
                            </td>
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" DeleteMethod="DeleteFormRDApplyDetailByID"
        SelectMethod="GetFormRDApplyDetail" TypeName="BusinessObjects.FormRDBLL" OnInserting="odsDetails_Inserting"
        OnObjectCreated="odsDetails_ObjectCreated" OnUpdating="odsDetails_Updating" InsertMethod="AddFormRDApplyDetail"
        UpdateMethod="UpdateFormRDApplyDetail">
        <InsertParameters>
