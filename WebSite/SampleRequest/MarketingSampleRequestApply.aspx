<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MarketingSampleRequestApply.aspx.cs" Culture="Auto" UICulture="Auto"
    Inherits="FormMarketing_MarketingApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_ExpenseItem %>">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:SqlDataSource ID="odsExpenseItem" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
                                SelectCommand="select ExpenseItemID,ExpenseItemName from ExpenseItem where IsActive=1 and ExpenseSubCategoryID = @ExpenseSubCategoryID order by ExpenseItemName">
                                <SelectParameters>
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" DeleteMethod="DeleteFormMarketingApplyDetailByID"
        SelectMethod="GetFormMarketingApplyDetail" TypeName="BusinessObjects.FormSampleRequestBLL"
        ...
        <UpdateParameters>
            <asp:Parameter Name="FormMarketingApplyDetailID" Type="Int32" />
            <asp:Parameter Name="ExpenseItemID" Type="Int32" />
            <asp:Parameter Name="SKUID" Type="Int32" />
            <asp:Parameter Name="Amount" Type="Decimal" />
            <asp:Parameter Name="AmountRMB" Type="Decimal" />
