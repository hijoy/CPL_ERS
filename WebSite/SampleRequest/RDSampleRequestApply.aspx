<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RDSampleRequestApply.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormRD_RDApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="searchTable">
            ...
            <tr>
                <td colspan="2" style="width: 400px">
                    ...
                    <div>
                        <asp:TextBox ID="txtProjectName" runat="server" Width="370px"></asp:TextBox>
                    </div>
                </td>
                <td colspan="2" style="width: 400px">
                    <div class="field_title">
            ...
            <gc:GridView ID="gvDetails" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        ...
                        <EditItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Update" Text="<%$ Resources:Common,Button_Update %>"
                    ...
                    <table>
                        <tr class="Header">
                            ...
                            <td style="width: 100px;">
                                <asp:Label ID="Label5" runat="server" meta:resourcekey="LabelResource21" />
                            </td>
                            <td style="width: 100px;">
                                <asp:Label ID="Label1" runat="server" meta:resourcekey="LabelResource22" />
                            </td>
                            <td style="width: 100px;">
                                <asp:Label ID="Label6" runat="server" meta:resourcekey="LabelResource20" />
                            </td>
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" DeleteMethod="DeleteFormRDApplyDetailByID"
        SelectMethod="GetFormRDApplyDetail" TypeName="BusinessObjects.FormSampleRequestBLL"
        OnInserting="odsDetails_Inserting" OnObjectCreated="odsDetails_ObjectCreated"
        OnUpdating="odsDetails_Updating" InsertMethod="AddFormRDApplyDetail" UpdateMethod="UpdateFormRDApplyDetail">
        <InsertParameters>
        ...
        <UpdateParameters>
            <asp:Parameter Name="FormRDApplyDetailID" Type="Int32" />
            <asp:Parameter Name="ExpenseItemID" Type="Int32" />
            <asp:Parameter Name="SKUID" Type="Int32" />
            <asp:Parameter Name="Amount" Type="Decimal" />
            <asp:Parameter Name="AmountRMB" Type="Decimal" />
