...
public partial class BudgetManage_BudgetManageFee : BasePage {
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (!this.IsPostBack) {
            ...
            this.GVBudget.Columns[6].Visible = (bool)this.ViewState["HasManageRight"];
        }
    }
    ...
    protected void SearchBtn_Click(object sender, EventArgs e) {
        if (!checkSearchConditionValid()) {
            ...
            if (SearchExpenseTypeDDL.SelectedValue != "0") {
                filterStr += " AND ManageExpenseItemID = " + this.SearchExpenseTypeDDL.SelectedValue;
            }
            //费用期间
            ...
            if (startPeriod != null && startPeriod != string.Empty) {
                ...
                filterStr += " AND Year >=" + startPeriod.Substring(0, 4) +
                    " AND Year<=" + endPeriod.Substring(0, 4);
            }
    ...
    public string GetExpenseTypeNameByID(object ExpenseTypeID) {
        ...
        return new MasterDataBLL().GetManageExpenseItemById(id).ManageExpenseItemName;
    }
