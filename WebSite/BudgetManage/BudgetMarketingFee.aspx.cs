...
public partial class BudgetManage_BudgetMarketing : BasePage {
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (!this.IsPostBack) {
            ...
            int opViewId = BusinessUtility.GetBusinessOperateId(SystemEnums.BusinessUseCase.BudgetMarketing, SystemEnums.OperateEnum.View);
            int opManageId = BusinessUtility.GetBusinessOperateId(SystemEnums.BusinessUseCase.BudgetMarketing, SystemEnums.OperateEnum.Manage);
    ...
    protected void SearchBtn_Click(object sender, EventArgs e) {
        if (!checkSearchConditionValid()) {
            ...
            this.odsHistory.SelectParameters["BudgetMarketingID"].DefaultValue = "";
        }
    }
    ...
    protected void GVBudget_SelectedIndexChanged(object sender, EventArgs e) {
        // 将选中的“编码”传给“子类别”
        this.odsHistory.SelectParameters["BudgetMarketingID"].DefaultValue = this.GVBudget.SelectedValue.ToString();
    }
