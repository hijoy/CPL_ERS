...
public partial class BudgetManage_BudgetRD : BasePage {
    ...
    protected void SearchBtn_Click(object sender, EventArgs e) {
        if (!checkSearchConditionValid()) {
            ...
            this.odsHistory.SelectParameters["BudgetRDID"].DefaultValue = "";
        }
    }
    ...
    protected void GVBudget_SelectedIndexChanged(object sender, EventArgs e) {
        // 将选中的“编码”传给“子类别”
        this.odsHistory.SelectParameters["BudgetRDID"].DefaultValue = this.GVBudget.SelectedValue.ToString();
    }
    ...
    public string getExpenseSubCategoryNameById(object Id) {
