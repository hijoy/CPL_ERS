<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BudgetMarketingFee.aspx.cs" Inherits="BudgetManage_BudgetMarketing"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UPBudget" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <gc:GridView CssClass="GridView" ID="GVBudget" runat="server" AutoGenerateColumns="False"
                DataKeyNames="BudgetMarketingID" CellPadding="0" DataSourceID="odsBudget" AllowPaging="True"
    ...
    <asp:UpdatePanel ID="AddUpdatePanel" runat="server">
        <ContentTemplate>
            <asp:FormView DefaultMode="Insert" ID="BudgetAddFormView" runat="server" DataKeyNames="BudgetMarketingID"
                        ...
                        <tr>
                            ...
                            <td align="center" style="width: 120px;">
                                ...
                                <asp:SqlDataSource ID="sdsExpenseCategory" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
                                    SelectCommand="Select ExpenseCategoryID,ExpenseCategoryName FROM ExpenseCategory where BusinessType=2">
                                </asp:SqlDataSource>
                            </td>
                            <td align="center" style="width: 120px;">
    ...
    <asp:ObjectDataSource ID="odsBudget" runat="server" InsertMethod="InsertBudgetMarketing"
        SelectMethod="GetPagedBudgetMarketing" DeleteMethod="DeleteBudgetMarketingByID"
        TypeName="BusinessObjects.BudgetBLL" UpdateMethod="UpdateBudgetMarketing" EnablePaging="True"
        SortParameterName="sortExpression" SelectCountMethod="QueryBudgetMarketingTotalCount"
    ...
    <asp:UpdatePanel ID="UPHistory" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <gc:GridView CssClass="GridView" ID="GVHistory" runat="server" AutoGenerateColumns="False"
                DataKeyNames="BudgetMarketingHistoryID" DataSourceID="odsHistory" >
                <Columns>
    ...
    <asp:ObjectDataSource ID="odsHistory" runat="server" SelectMethod="GetBudgetMarketingHistory"
        TypeName="BusinessObjects.BudgetBLL">
        <SelectParameters>
            <asp:Parameter Name="BudgetMarketingID" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
