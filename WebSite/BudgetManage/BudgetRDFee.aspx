<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BudgetRDFee.aspx.cs" Inherits="BudgetManage_BudgetRD"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UPBudget" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <gc:GridView CssClass="GridView" ID="GVBudget" runat="server" AutoGenerateColumns="False"
                DataKeyNames="BudgetRDID" CellPadding="0" DataSourceID="odsBudget" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField SortExpression="ExpenseSubCategoryID" meta:resourcekey="TemplateField_ExpenseSubCategory">
                        <ItemTemplate>
                            <asp:Label ID="lblExpenseSubCategoryID" runat="server" Text='<%# getExpenseSubCategoryNameById(Eval("ExpenseSubCategoryID")) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="120px" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_ModifyReason">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtModifyReason" runat="server" Text='<%# Bind("ModifyReason") %>'
                                Width="110px" meta:resourcekey="txtModifyReasonResource1"></asp:TextBox>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblModifyReason" runat="server" Text='<%# Bind("ModifyReason") %>'
                                meta:resourcekey="lblModifyReasonResource1" />
                        </ItemTemplate>
                ...
                <EmptyDataTemplate>
                    <table>
                        <tr class="Header">
                            ...
                            <td style="width: 120px">
                                <asp:Label ID="Label4" runat="server" meta:resourcekey="Label_ExpenseSubCategory" />
                            </td>
                            <td style="width: 120px">
    ...
    <asp:UpdatePanel ID="AddUpdatePanel" runat="server">
        <ContentTemplate>
            <asp:FormView DefaultMode="Insert" ID="BudgetAddFormView" runat="server" DataKeyNames="BudgetRDID"
                ...
                <InsertItemTemplate>
                    <table style="height: 30px;" class="FormView">
                        <tr>
                            ...
                            <td align="center" style="width: 120px;">
                                <asp:DropDownList ID="ddlExpenseSubCategory" runat="server" SelectedValue='<%# Bind("ExpenseSubCategoryID") %>'
                                    DataSourceID="sdsExpenseSubCategory" DataTextField="ExpenseSubCategoryName" DataValueField="ExpenseSubCategoryID"
                                    Width="100px">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="sdsExpenseSubCategory" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
                                    SelectCommand="Select ExpenseSubCategoryID,ExpenseSubCategoryName FROM ExpenseSubCategory where ExpenseCategoryID=62">
                                </asp:SqlDataSource>
                            </td>
                            <td align="center" style="width: 120px;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="UCFPeriod$txtDate"
                                    Display="None" meta:resourcekey="RequiredFieldValidator_FPeriod" SetFocusOnError="True" ValidationGroup="INS"></asp:RequiredFieldValidator>
                            </td>
                            ...
                            <td align="center" style="width: 80px;">
                                ...
                                <asp:RequiredFieldValidator ID="RFProjection" runat="server" ControlToValidate="txtProjectionBudget"
                                    Display="None" meta:resourcekey="RequiredFieldValidator_Projection" SetFocusOnError="True" ValidationGroup="INS"></asp:RequiredFieldValidator>
    ...
    <asp:ObjectDataSource ID="odsBudget" runat="server" InsertMethod="InsertBudgetRD"
        SelectMethod="GetPagedBudgetRD" DeleteMethod="DeleteBudgetRDByID"
        TypeName="BusinessObjects.BudgetBLL" UpdateMethod="UpdateBudgetRD" EnablePaging="True"
        SortParameterName="sortExpression" SelectCountMethod="QueryBudgetRDTotalCount"
    ...
    <asp:UpdatePanel ID="UPHistory" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <gc:GridView CssClass="GridView" ID="GVHistory" runat="server" AutoGenerateColumns="False"
                DataKeyNames="BudgetRDHistoryID" DataSourceID="odsHistory" >
                <Columns>
                    ...
                    <asp:TemplateField  meta:resourcekey="Form_AdjustBudget">
                        <ItemTemplate>
                            <asp:Label ID="lblAdjustBudget" runat="server" Text='<%# Eval("AdjustBudget", "{0:N}") %>'/>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Right" Width="100px" />
    ...
    <asp:ObjectDataSource ID="odsHistory" runat="server" SelectMethod="GetBudgetRDHistory"
        TypeName="BusinessObjects.BudgetBLL">
        <SelectParameters>
            <asp:Parameter Name="BudgetRDID" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>
