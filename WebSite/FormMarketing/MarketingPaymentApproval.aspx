<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MarketingPaymentApproval.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormMarketing_MarketingPaymentApproval" %>
            ...
            <gc:GridView ID="gvPaymentDetails" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_ExpenseItem %>">
                        <ItemTemplate>
                            <asp:Label ID="lblExpenseName" runat="server" Text='<%# GetExpenseItemNameByID(Eval("ExpenseItemID")) %>'></asp:Label>
                        </ItemTemplate>
...
<%--                    <asp:TemplateField meta:resourcekey="Label_ApplyAmount">
                    ...
                    <asp:TemplateField HeaderText="PO NO">
                        <ItemTemplate>
                            <asp:HyperLink ID="lblPOFormNo" runat="server" Text='<%# Eval("POFormNo") %>'></asp:HyperLink>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_Remark %>">
                        <ItemTemplate>
                            <asp:Label ID="lblRemark" runat="server" Text='<%# GetApplyRemark(Eval("FormMarketingApplyDetailID")) %>'></asp:Label>
                        </ItemTemplate>
    ...
    <asp:ObjectDataSource ID="odsPaymentDetails" runat="server" SelectMethod="GetFormMarketingPaymentDetailByPaymentID"
        TypeName="BusinessObjects.FormMarketingBLL">
        <SelectParameters>
            <asp:Parameter Name="FormMarketingPaymentID" Type="Int32" />
        </SelectParameters>
