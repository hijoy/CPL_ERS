<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MarketingPaymentSelectForPO.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormMarketing_MarketingPaymentSelectForPO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <gc:GridView CssClass="GridView" ID="gvApplyList" runat="server" DataSourceID="odsApplyList"
        ...
        <Columns>
            ...
            <asp:TemplateField  HeaderText="·½°¸¼òÊö">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Ê£Óà½ð¶î">
                <ItemTemplate>
                    <asp:Label ID="lblRemainAmountRMB" runat="server" ></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="80px" HorizontalAlign="right" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="<%$Resources:Common,Label_Operate %>">
                <ItemTemplate>
                    <asp:LinkButton ID="lbCreatePO" runat="server" CausesValidation="False" CommandName="Select"
                        meta:resourcekey="Label_CreatePO"></asp:LinkButton>
                </ItemTemplate>
                <ItemStyle Width="80px" HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
            ...
            <table>
                <tr class="Header">
                    ...
                    <td style="width: 280px;">
                        <asp:Label ID="Label4"  runat="server" Text="<%$Resources:Common,Form_ProjectName %>" />
                    </td>
                    <td style="width: 80px;">
                        <asp:Label ID="Label5"  runat="server" Text="<%$Resources:Common,Form_AmountRMB %>" />
                    </td>
                    <td style="width: 80px;">
                        <asp:Label ID="Label7"  runat="server" Text="Ê£Óà½ð¶î" />
                    </td>
                    <td style="width: 60px;">
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormMarketingApplyView" EnablePaging="True" SelectCountMethod="QueryFormMarketingApplyViewCount"
