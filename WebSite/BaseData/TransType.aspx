<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Culture="auto" UICulture="auto" CodeFile="TransType.aspx.cs" Inherits="BaseData_TransType" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="title">
        <asp:Label ID="Label6" runat="server" meta:resourcekey="Label_Title"></asp:Label>
    </div>
    <asp:UpdatePanel ID="TransTypeUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <gc:GridView ID="TransTypeView" CssClass="GridView" runat="server" DataSourceID="TransTypeObjectDataSource"
                AllowPaging="false" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="TransTypeID"
                CellPadding="0">
                <Columns>
                    <asp:TemplateField meta:resourcekey="TransTypeGridView_TemplateField_TransTypeName" SortExpression="TransTypeName">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTransTypeName" runat="server" CssClass="InputText" MaxLength="20"
                                Text='<%# Bind("TransTypeName") %>' Width="400px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="TransTypeNameRequiredFieldValidator" runat="server" ControlToValidate="txtTransTypeName"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblTransTypeName" runat="server" Text='<%# Bind("TransTypeName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField meta:resourcekey="TransTypeGridView_TemplateField_Description" SortExpression="Description">
                        <EditItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblTransTypeNo" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <table>
                        <tr class="Header">
                            <td scope="col" style="width: 600px" class="Empty1">
                                <asp:Label ID="Label1" runat="server"  meta:resourcekey="TransType_Label_TransTypeName"></asp:Label>
                            </td>
                            <td scope="col" style="width: 350px">
                                <asp:Label ID="Label2" runat="server" meta:resourcekey="TransType_Label_Description"></asp:Label>
                            </td>
            ...
            <asp:FormView ID="TransTypeFormView" runat="server" DataKeyNames="TransTypeID" CellPadding="0"
                CellSpacing="0" DataSourceID="TransTypeObjectDataSource" DefaultMode="Insert" >
                <InsertItemTemplate>
                    <table class="FormView">
                        <tr>
                            <td align="center" style="width: 600px">
                                <asp:TextBox ID="txtTransTypeName" runat="server" Text='<%# Bind("TransTypeName") %>' CssClass="InputText"
    ...
    <asp:ObjectDataSource ID="TransTypeObjectDataSource" runat="server" InsertMethod="InsertTransType"
        SelectMethod="GetTransType" TypeName="BusinessObjects.MasterDataBLL" UpdateMethod="UpdateTransType">
        <UpdateParameters>
            <asp:Parameter Name="TransTypeID" Type="Int32" />
            <asp:Parameter Name="TransTypeName" Type="String" />
