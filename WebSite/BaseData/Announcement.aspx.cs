...
public partial class BaseData_Announcement : BasePage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (!this.IsPostBack) {
            //判断权限
            String titleStr = this.GetLocalResourceObject("titleLabel.Text").ToString();
            PageUtility.SetContentTitle(this, titleStr);

            this.Page.Title = titleStr;
    ...
    protected void BindData(LinkButton button) {
        ...
        MasterData.BulletinRow bulletin = ms.GetBulletinById(selectID)[0];
