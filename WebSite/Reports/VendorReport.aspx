<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="VendorReport.aspx.cs" Inherits="Reports_DemoReport" Culture="Auto" UICulture="Auto"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="searchDiv" style="width: 1260px;">
        <table class="searchTable" cellpadding="0" cellspacing="0">
            <tr style="vertical-align: top; height: 40px">
                <td width="200px">
                    <div class="field_title">
                        <asp:Label ID="Label_VendorCode" runat="server" meta:resourcekey="Label_CompanyCode" /></div>
                    <asp:DropDownList ID="CompanyCode" runat="server" DataSourceID="odsCompanyCode"
                        DataTextField="CompanyName" DataValueField="CompanyCode" Width="150px">
                    </asp:DropDownList>
                </td>
                <td width="200px">
                    <div class="field_title">
    ...
    <asp:SqlDataSource ID="odsCompanyCode" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
        SelectCommand="select '%' CompanyCode,'ALL' CompanyName union select CompanyCode,CompanyCode+'--'+CompanyName CompanyName from Company ">
    </asp:SqlDataSource>
</asp:Content>
