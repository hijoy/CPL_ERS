<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReportTEBudget.aspx.cs" Inherits="ReportView" Culture="Auto" UICulture="Auto"%>
        ...
        <table class="searchTable" cellpadding="0" cellspacing="0">
            <tr >
                <td width="80px" align="right">
                    <asp:Label ID="Label_UserId" runat="server" meta:resourcekey="Label_FinanceYear" />
                    &nbsp;
                </td>
                <td style="width: 120px;">
                    <asp:TextBox ID="FinanceYear" MaxLength="4" runat="server" Width="70px"></asp:TextBox>
                </td>
