<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OUSelect.ascx.cs" Inherits="UserControls_OUSelect" %>
...
<input type="button" style="height:18px;display:<%= IsNoClear%>;" class="button_small" value="Clear" onclick="<%= GetResetScript() %>" />
