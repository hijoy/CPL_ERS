<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaleApplyList.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormQuery_SaleApplyList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table>
                <tr class="Header">
                    ...
                    <td style="width: 240px;">
                        <asp:Label ID="Label6" runat="server" Text="<%$Resources:Common,Form_ProjectName %>" />
                    </td>
                    <td style="width: 80px;">
                        <asp:Label ID="Label7" runat="server" Text="<%$Resources:Common,Form_AmountRMB %>" />
                    </td>
                    <td style="width: 60px;">
                        <asp:Label ID="Label8" runat="server" Text="<%$Resources:Common,Form_Period %>" />
                    </td>
                    <td style="width: 100px;">
                        <asp:Label ID="Label9" runat="server" Text="<%$Resources:Common,Form_ExpenseSubCategory %>" />
                    </td>
                    <td style="width: 50px;">
                        <asp:Label ID="Label10" runat="server" Text="<%$Resources:Common,Form_Currency %>" />
                    </td>
                    <td style="width: 60px;">
                        <asp:Label ID="Label11" runat="server" Text="<%$Resources:Common,Form_ApplyUser %>" />
                    </td>
                    <td style="width: 75px;">
                        <asp:Label ID="Label12" runat="server" Text="<%$Resources:Common,Form_SubmitDate %>" />
                    </td>
                </tr>
                <tr>
                    <td colspan="12" class="Empty2 noneLabel">
    ...
    <asp:DataGrid ID="ExportDataGrid" runat="server" Visible="true" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:BoundColumn HeaderText="<%$Resources:Common,Form_Brand %>" DataField="BrandName"
                HeaderStyle-Font-Bold="true" />
            <asp:BoundColumn HeaderText="<%$Resources:Common,Form_ProjectName %>" DataField="ProjectName"
                HeaderStyle-Font-Bold="true" />
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormSaleApplyViewByRight" EnablePaging="True" SelectCountMethod="QueryFormSaleApplyViewCountByRight"
