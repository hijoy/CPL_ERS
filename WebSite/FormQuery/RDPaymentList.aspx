<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RDPaymentList.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormQuery_RDPaymentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <gc:GridView CssClass="GridView" ID="gvApplyList" runat="server" DataSourceID="odsApplyList"
        ...
        <Columns>
            ...
            <asp:TemplateField SortExpression="ProjectName" HeaderText="<%$Resources:Common,Form_ProjectName %>">
                ...
                <ItemStyle Width="310px" HorizontalAlign="Center" />
            </asp:TemplateField>
            ...
            <asp:TemplateField SortExpression="FormRDPayment.AmountRMB" meta:resourcekey="TemplateField_AmountRMB">
                <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormRDPaymentViewByRight" EnablePaging="True" SelectCountMethod="QueryFormRDPaymentViewCountByRight"
