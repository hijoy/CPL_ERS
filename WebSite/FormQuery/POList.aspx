<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="POList.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormQuery_POList"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <tr>
                <td  style="width: 200px">
                    <div class="field_title">
                        ...
                        <uc3:UCVendor ID="UCVendor" runat="server"  Width="100px"/>
                </td>
            ...
            <tr style=" height:40px">
                ...
                <td style="width: 400px;" colspan="2" valign="middle">
                    <span class="field_title">
                        <asp:Label ID="Label_POType" runat="server" meta:resourcekey="Label_POType" />
                    </span>&nbsp;&nbsp;
                    <asp:CheckBox ID="chkPurchase" runat="server" meta:resourcekey="CheckBox_Purchase" Checked="false"></asp:CheckBox>&nbsp;
                    <asp:CheckBox ID="chkSale" runat="server" meta:resourcekey="CheckBox_Sale" Checked="false" />&nbsp;
                    <asp:CheckBox ID="chkMarketing" runat="server" meta:resourcekey="CheckBox_Marketing" Checked="false" />&nbsp;
                    <asp:CheckBox ID="chkRD" runat="server" meta:resourcekey="CheckBox_RD" Checked="false" />
                </td>
                <td style="width: 400px;" colspan="2" valign="middle">
                    <span class="field_title">
    ...
    <asp:DataGrid ID="ExportDataGrid" runat="server" Visible="true" AutoGenerateColumns="false">
        <Columns>
            ...
            <asp:BoundColumn HeaderText="<%$Resources:Common,Form_DeliveryAddress %>" DataField="DeliveryAddress" HeaderStyle-Font-Bold="true" />
            <asp:BoundColumn HeaderText="<%$Resources:Common,Form_PaymentTerms %>" DataField="PaymentTerms" HeaderStyle-Font-Bold="true" />
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormPOViewByRight" EnablePaging="True" SelectCountMethod="QueryFormPOViewCountByRight"
