<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MarketingApplyList.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormQuery_MarketingApplyList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormMarketingApplyViewByRight" EnablePaging="True" SelectCountMethod="QueryFormMarketingApplyViewCountByRight"
