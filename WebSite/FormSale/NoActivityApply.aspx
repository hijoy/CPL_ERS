<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="NoActivityApply.aspx.cs" Inherits="FormSale_NoActivityApply" Culture="auto"
    UICulture="auto" %>
    ...
    <div class="searchDiv">
        <table class="searchTable">
            ...
            <tr>
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Common,Label_CustomerNo %>" /></div>
                    <div>
            ...
            <tr>
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label3" runat="server" meta:resourcekey="LabelResource5" />
                        <span class="requiredLable">*</span>
                    </div>
                    <div>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label1" runat="server" meta:resourcekey="LabelResource6" />
                        <span class="requiredLable">*</span>
                    </div>
                    <div>
            ...
            <gc:GridView ID="gvDetails" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                <Columns>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource3">
                        ...
                        <FooterTemplate>
                            <asp:Label runat="server" ID="lblTotal" meta:resourcekey="lblTotalResource1"></asp:Label>
                        </FooterTemplate>
                    ...
                    <table>
                        <tr class="Header">
                            ...
                            <td style="width: 100px;">
                                <asp:Label runat="server" meta:resourcekey="LabelResource19" />
                            </td>
                            <td style="width: 100px;">
                        ...
                        <tr>
                            ...
                            <td style="width: 100px;" align="center">
                                <asp:LinkButton ID="InsertButton" runat="server" CommandName="Insert" Text="<%$Resources:Common,Button_Add %>"
                                    ValidationGroup="NewExpenseDetailRow"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <asp:RequiredFieldValidator ID="RF1" runat="server" ControlToValidate="newAmountCtl"
                                Display="None" ValidationGroup="NewExpenseDetailRow" SetFocusOnError="True" meta:resourcekey="RF1Resource1"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RF3" runat="server" ControlToValidate="newAmountCtl"
                                ...
                                ValidationGroup="NewDetailRow" meta:resourcekey="RF3Resource1"></asp:RegularExpressionValidator>
                            <asp:ValidationSummary ID="ValidationSummaryINS" runat="server" ShowMessageBox="True"
                                ShowSummary="False" ValidationGroup="NewExpenseDetailRow" meta:resourcekey="ValidationSummaryINSResource1" />
                        </tr>
                    </table>
                </InsertItemTemplate>
            </asp:FormView>
