<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaleApplySelectListForPO.aspx.cs" UICulture="Auto" Culture="Auto" Inherits="FormSale_SaleApplySelectListForPO"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <div class="title" >
        <asp:Label ID="Label_Title1" runat="server" meta:resourcekey="Label_Title1"/>
    </div>
            ...
            <asp:TemplateField HeaderText="<%$Resources:Common,Label_Operate %>">
                <ItemTemplate>
                    <asp:LinkButton ID="lbCreatePO" runat="server" CausesValidation="False" CommandName="Select"
                        meta:resourcekey="LinkButton_CreatePO"></asp:LinkButton>
                </ItemTemplate>
                <ItemStyle Width="80px" HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
