<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="NoActivityAdvancedPaymentApply.aspx.cs" Inherits="FormSale_NoActivityAdvancedPaymentApply"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="searchTable">
            ...
            <tr>
                ...
                <td style="width: 200px" valign="top">
                    ...
                    <div>
                        <uc4:UCVendor ID="UCVendor" runat="server" Width="140px" IsNoClear="true" IsLimited="true" />
                    </div>
                </td>
    ...
    <br />
    <div class="title">
        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Common,Label_InvoiceTitle %>" /></div>
