<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaleApplySelectList.aspx.cs" UICulture="Auto" Culture="Auto" Inherits="FormSale_SaleApplySelectList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <EmptyDataTemplate>
            <table>
                <tr class="Header">
                    ...
                    <td style="width: 100px;">
                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Common,Form_ExpenseSubCategory %>" />
                    </td>
                    <td style="width: 60px;">
                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:Common,Form_Currency %>" />
                    </td>
                    <td style="width: 60px;">
    ...
    <div style="margin-top: 20px; width: 1200px; text-align: right">
        <asp:Button ID="CreateBtn" runat="server" CssClass="button_nor" OnClick="CreateBtn_Click"
            meta:resourcekey="Button_Create" />&nbsp;&nbsp;
    </div>
    <br />
</asp:Content>
