<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PaymentFreeGoodsApply.aspx.cs" Inherits="FormSale_PaymentFreeGoodsApply"
    Culture="auto" UICulture="auto" %>

<%@ Register Src="../UserControls/SKUControl.ascx" TagName="UCSKU" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ParameterChanged(priceCtl, quantityCtl, amountCtl) {
                ...
                <td style="width: 200px">
                    ...
                    <div>
                        <asp:TextBox ID="PaymentTypeCtl" runat="server" CssClass="InputTextReadOnly" ReadOnly="True"
                            Width="170px" Text="Free Goods"></asp:TextBox>
                    </div>
                </td>
                <td style="width: 200px">
                    <div class="field_title">
    ...
    <br />
    <div class="title">
        <asp:Label ID="Label16" runat="server" meta:resourcekey="Label16Resource2" /></div>
            ...
            <gc:GridView ID="gvPaymentDetails" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                <Columns>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource21">
                        <ItemTemplate>
                            <asp:TextBox ID="txtAmountRMB" runat="server" Text='<%# Eval("AmountRMB") %>' Width="130px"></asp:TextBox>
                        </ItemTemplate>
    ...
    <asp:UpdatePanel ID="upGreeGoodsDetails" runat="server">
        <ContentTemplate>
            <gc:GridView ID="gvFreeGoods" runat="server" ShowFooter="True" CssClass="GridView"
                ...
                OnRowDataBound="gvFreeGoods_RowDataBound" CellPadding="0" OnDataBound="gvFreeGoods_OnDataBound">
                <Columns>
                    <asp:TemplateField HeaderText="<%$Resources:Common,Form_ProductName %>">
                        <ItemTemplate>
                            <asp:Label ID="lblProductName" runat="server" Text='<%# GetProductNameByID(Eval("SKUID")) %>'></asp:Label>
                        ...
                        <EditItemTemplate>
                            <uc1:UCSKU ID="UCSKU" runat="server" OnSKUNameTextChanged="UCSKU_SelectedIndexChanged"
                                IsNoClear="true" Width="200px" AutoPostBack="true" SKUID='<%# Bind("SKUID") %>' />
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource24">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="PackPerCaseCtl" runat="server" Width="80px" Text='<%# Eval("PackPerCase") %>'
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource25">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="DeliveryPriceCtl" runat="server" Width="80px" Text='<%# Eval("DeliveryPrice","{0:N}") %>'
                                ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="100px" HorizontalAlign="Right" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateFieldResource27">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="AmountRMBCtl" runat="server" Width="90px" Text='<%# Eval("AmountRMB","{0:N}") %>'
                                ReadOnly="True"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="100px" HorizontalAlign="Right" />
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Common,Form_Remark %>">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="RemarkCtl" runat="server" Text='<%# Bind("Remark") %>' Width="400px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="440px" HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField ShowHeader="False" meta:resourcekey="TemplateFieldResource29">
                        <ItemTemplate>
            ...
            <asp:FormView ID="fvFreeGoods" runat="server" DataKeyNames="FormSalePaymentFreeGoodsID"
                DataSourceID="odsFreeGoods" DefaultMode="Insert" CellPadding="0" OnDataBound="fvFreeGoods_OnDataBound">
                <InsertItemTemplate>
                    <table class="FormView">
                        <tr>
                            <td style="width: 300px;" align="center">
                                <uc1:UCSKU ID="NewUCSKU" runat="server" OnSKUNameTextChanged="NewUCSKU_SelectedIndexChanged"
                                    IsNoClear="true" Width="200px" AutoPostBack="true" />
                            </td>
                            <td style="width: 100px;" align="center" valign="top">
                                <asp:TextBox ID="NewPackPerCaseCtl" runat="server" Width="80px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td style="width: 100px;" align="center" valign="top">
                                <asp:TextBox ID="NewDeliveryPriceCtl" runat="server" Width="80px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td style="width: 100px;" align="center" valign="top">
                            ...
                            <td style="width: 100px;" align="center">
                                <asp:LinkButton ID="InsertButton" runat="server" CommandName="Insert" Text="<%$ Resources:Common,Button_Add %>"
                                    ValidationGroup="NewFreeGoodsVG"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <asp:RequiredFieldValidator ID="RF1" runat="server" ControlToValidate="NewQuantityCtl"
                                Display="None" ValidationGroup="NewFreeGoodsVG" SetFocusOnError="True" meta:resourcekey="RF1Resource1"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RF3" runat="server" ControlToValidate="NewQuantityCtl"
                                ValidationExpression="<%$ Resources:RegularExpressions, Number %>" Display="None"
                                ValidationGroup="NewFreeGoodsVG" meta:resourcekey="RF3Resource1"></asp:RegularExpressionValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="NewUCSKU$txtDisplaySKUName"
                                Display="None" ValidationGroup="NewFreeGoodsVG" SetFocusOnError="True" meta:resourcekey="RequiredFieldValidator3Resource1"></asp:RequiredFieldValidator>
                            <asp:ValidationSummary ID="ValidationSummaryINS" runat="server" ShowMessageBox="True"
                                ShowSummary="False" ValidationGroup="NewFreeGoodsVG" meta:resourcekey="ValidationSummaryINSResource1" />
                        </tr>
                    </table>
                    <br />
                </InsertItemTemplate>
    ...
    <asp:ObjectDataSource ID="odsFreeGoods" runat="server" DeleteMethod="DeleteFormSalePaymentFreeGoodsByID"
        SelectMethod="GetFormSalePaymentFreeGoods" TypeName="BusinessObjects.FormSaleBLL"
        OnInserting="odsFreeGoods_Inserting" OnUpdating="odsFreeGoods_Updating" OnObjectCreated="odsFreeGoods_ObjectCreated"
        InsertMethod="AddFormSalePaymentFreeGoods" UpdateMethod="UpdateFormSalePaymentFreeGoods">
        <DeleteParameters>
            <asp:Parameter Name="FormSalePaymentFreeGoodsID" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
