<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PRApplyFirst.aspx.cs" Inherits="FormPurchase_PRApplyFirst" Culture="Auto"
    UICulture="Auto" %>
        ...
        <table style="padding-left:20px">
            <tr>
                ...
                <td style="width: 240px">
                    ...
                    <div>
                        <asp:DropDownList ID="PurchaseBudgetTypeDDL" runat="server" DataSourceID="odsPurchaseBudgetTypeID" DataTextField="PurchaseBudgetTypeName" DataValueField="PurchaseBudgetTypeID" Width="200px" >
                        </asp:DropDownList>
