<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PRApproval.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_PRApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="searchDiv">
        <table class="searchTable">
            ...
            <tr>
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label4" runat="server" Text="是否已关闭" /></div>
                    <div><asp:CheckBox ID="IsCloseCtl" runat="server" Enabled="false" /></div>
                </td>
            ...
            <tr>
                ...
                <td colspan="3" valign="top">
                    <div class="field_title">
                        ...
                        <uc2:UCFlie ID="UCFileUpload" runat="server" Width="600px" IsView="true"/>
                </td>
    ...
    <div class="title" ><asp:Label ID="Label1"  runat="server" Text="<%$Resources:Common,Form_BudgetTitle %>" /></div>
    <div class="searchDiv">
        <table class="searchTable">
            <tr>
                <td style="width: 200px">
    ...
    <asp:UpdatePanel ID="upDetails" runat="server">
        <ContentTemplate>
            <gc:GridView ID="gvDetails" runat="server" ShowFooter="True" CssClass="GridView" AutoGenerateColumns="False" DataKeyNames="FormPRDetailID" DataSourceID="odsDetails"
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" SelectMethod="GetPRDetailByFormPRID" TypeName="BusinessObjects.FormPurchaseBLL">
        <SelectParameters>
    ...
    <asp:UpdatePanel ID="upButton" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <div style="margin-top: 20px; width: 1200px; text-align: right">
                ...
                <asp:Button ID="CloseBtn" runat="server" OnClick="CloseBtn_Click" OnClientClick="return window.confirm('确定要关闭么，关闭之后将不能操作？');"
                     meta:resourcekey="Button_Close" CssClass="button_nor" />&nbsp;
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    <br />
