<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PRSelectList.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_PRSelectList"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsApplyList" runat="server" TypeName="BusinessObjects.FormQueryBLL"
        SelectMethod="GetPagedFormPRView" EnablePaging="True" SelectCountMethod="QueryFormPRViewCount"
