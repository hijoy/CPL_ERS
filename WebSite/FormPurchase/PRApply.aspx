<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PRApply.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_PRApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="searchTable">
            ...
            <tr>
                ...
                <td style="width: 200px">
                    ...
                    <div>
                        <asp:DropDownList ID="ShippingTermDDL" runat="server" DataSourceID="odsShippingTerm"
                            DataTextField="ShippingTermName" DataValueField="ShippingTermID" Width="180px">
                        </asp:DropDownList>
                ...
                <td colspan="2" style="width: 400px">
                    ...
                    <div>
                        <asp:DropDownList ID="CompanyDDL" runat="server" DataSourceID="odsCompany" DataTextField="CompanyAddress"
                            DataValueField="CompanyID" Width="370px" AutoPostBack="true" OnSelectedIndexChanged="CompanyDDL_SelectedIndexChanged">
                        </asp:DropDownList>
            ...
            <tr>
                <td colspan="2" style="width: 400px">
                    ...
                    <div>
                        <asp:TextBox ID="RealDeliveryAddressCtl" runat="server" Width="340px"></asp:TextBox></div>
                </td>
    ...
    <br />
    <div class="title">
        <asp:Label runat="server" Text="<%$Resources:Common,Form_BudgetTitle %>" /></div>
    <div class="searchDiv">
        <table class="searchTable">
            <tr>
                <td style="width: 200px">
                ...
                <td style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label_NonReimbursedAmount" runat="server" meta:resourcekey="Label_NonReimbursedAmount" />
                    </div>
                    <div>
    ...
    <asp:UpdatePanel ID="upDetails" runat="server">
        <ContentTemplate>
            <gc:GridView ID="gvDetails" runat="server" ShowFooter="True" CssClass="GridView"
                AutoGenerateColumns="False" DataKeyNames="FormPRDetailID" DataSourceID="odsDetails"
                ...
                <Columns>
                    <asp:TemplateField meta:resourcekey="TemplateField_Item">
                        ...
                        <EditItemTemplate>
                            <uc4:UCItem ID="UCItem" runat="server" ItemID='<%# Bind("ItemID") %>' OnItemNameTextChanged="UCItem_SelectedIndexChanged"
                                IsNoClear="true" Width="220px" ItemCategoryID="<%# CategoryID %>" AutoPostBack="true" />
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_Package">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="PackageCtl" runat="server" Width="40px" Text='<%# Eval("Package") %>'
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_UnitPrice">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="UnitPriceCtl" runat="server" Width="40px" Text='<%# Eval("UnitPrice","{0:N}") %>'
                                ReadOnly="true"></asp:TextBox>
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_FinalPrice">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="FinalPriceCtl" runat="server" Text='<%# Bind("FinalPrice") %>' Width="50px"></asp:TextBox>
                        </EditItemTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_Quantity">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="QuantityCtl" runat="server" Text='<%# Bind("Quantity") %>' Width="50px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="70px" HorizontalAlign="Right" />
                        <FooterTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_Amount">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="AmountCtl" runat="server" Width="50px" Text='<%# Eval("Amount","{0:N}") %>'
                                ReadOnly="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="70px" HorizontalAlign="Right" />
                        <FooterTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_AmountRMB">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="AmountRMBCtl" runat="server" Width="50px" Text='<%# Eval("AmountRMB","{0:N}") %>'
                                ReadOnly="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="70px" HorizontalAlign="Right" />
                        <FooterTemplate>
                    ...
                    <asp:TemplateField meta:resourcekey="TemplateField_ItemDescription">
                        <ItemTemplate>
                            <asp:Label ID="lblDeliveryAddress" runat="server" Text='<%# Eval("DeliveryAddress") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="DeliveryAddressCtl" runat="server" Text='<%# Bind("DeliveryAddress") %>'
                ...
                <EmptyDataTemplate>
                    <table>
                        <tr class="Header">
                            <td style="width: 260px;" class="Empty1">
                            ...
                            <td style="width: 320px;">
                                <asp:Label ID="Label9" runat="server" meta:resourcekey="Label_ItemDescription" />
                            </td>
                            <td style="width: 70px">
                                &nbsp;
                            </td>
            ...
            <asp:FormView ID="fvDetails" runat="server" DataKeyNames="FormPRDetailID" DataSourceID="odsDetails"
                DefaultMode="Insert" CellPadding="0" OnDataBound="fvDetails_OnDataBound">
                <InsertItemTemplate>
                    <table class="FormView">
                        <tr>
                            <td style="width: 260px;" align="center">
                                <uc4:UCItem ID="NewUCItem" runat="server" ItemID='<%# Bind("ItemID") %>' OnItemNameTextChanged="NewUCItem_SelectedIndexChanged"
                                    IsNoClear="true" Width="220px" AutoPostBack="true" />
                            </td>
                            <td style="width: 60px;" align="center" valign="top">
                                <asp:TextBox ID="NewPackageCtl" runat="server" Width="40px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td style="width: 60px;" align="center" valign="top">
                                <asp:TextBox ID="NewUnitPriceCtl" runat="server" Width="40px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td style="width: 70px;" align="center">
                                <asp:TextBox ID="NewFinalPriceCtl" runat="server" Text='<%# Bind("FinalPrice") %>'
                                    Width="50px"></asp:TextBox>
                            </td>
                            <td style="width: 70px;" align="center">
                                <asp:TextBox ID="NewQuantityCtl" runat="server" Text='<%# Bind("Quantity") %>' Width="50px"></asp:TextBox>
                            </td>
                            <td style="width: 70px;" align="center">
                                <asp:TextBox ID="NewAmountCtl" runat="server" Width="50px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td style="width: 70px;" align="center">
                                <asp:TextBox ID="NewAmountRMBCtl" runat="server" Width="50px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td style="width: 150px;" align="center">
                                <uc1:UCDateInput ID="NewUCDeliveryDate" runat="server" SelectedDate='<%# Bind("DeliveryDate") %>' />
                            </td>
                            <td style="width: 320px;" align="center">
                                <asp:TextBox ID="NewDeliveryAddressCtl" runat="server" Text='<%# Bind("DeliveryAddress") %>'
                                    Width="300px"></asp:TextBox>
                            </td>
                            <td style="width: 70px;" align="center">
                        ...
                        <tr>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NewUCDeliveryDate$txtDate"
                                Display="None" meta:resourcekey="RequiredFieldValidator_RF3" ValidationGroup="NewDetailRow"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="NewUCItem$txtDisplayItemName"
                                Display="None" meta:resourcekey="RequiredFieldValidator_RF4" ValidationGroup="NewDetailRow"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="NewDeliveryAddressCtl"
                                Display="None" meta:resourcekey="RequiredFieldValidator_RF5" ValidationGroup="NewDetailRow"
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" DeleteMethod="DeleteFormPRDetailByID"
        SelectMethod="GetPRDetail" TypeName="BusinessObjects.FormPurchaseBLL" OnInserting="odsDetails_Inserting"
        OnObjectCreated="odsDetails_ObjectCreated" OnUpdating="odsDetails_Updating" InsertMethod="AddFormPRDetail"
        UpdateMethod="UpdateFormPRDetail">
        <DeleteParameters>
            <asp:Parameter Name="FormPRDetailID" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="FormPRID" Type="Int32" />
