<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="POApproval.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_POApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="title"><asp:Label ID="Label1" Text="<%$Resources:Common,Label_BasicInfo %>" runat="server" /></div>
    <div class="searchDiv">
        <table class="searchTable">
            ...
            <tr>
                ...
                <td style="width: 200px">
                    ...
                    <div>
                        <asp:TextBox ID="PRAmountCtl" runat="server" Width="170px"  CssClass="InputTextReadOnly" ReadOnly="true"></asp:TextBox></div>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: 400px">
                    ...
                    <div>
                        <asp:TextBox ID="DeliveryAddressCtl" runat="server" CssClass="InputTextReadOnly" ReadOnly="true"
                            Width="370px"></asp:TextBox></div>
                </td>
                <td colspan="2"  style="width: 400px">
                    <div class="field_title">
                        <asp:Label ID="Label4" runat="server" Text="<%$Resources:Common,Form_DeliveryAddress %>" /></div>
                    <div>
                ...
                <td style="width: 200px" valign="top">
                    <div class="field_title">
                        <asp:Label ID="Label_FormNoPR" runat="server" meta:resourcekey="Label_FormNoPR" /></div>
                    <div style="margin-top: 5px">
                        <asp:HyperLink ID="FormPRNoCtl" runat="server"></asp:HyperLink></div>
                </td>
                <td runat="server" id="PONoTR" style="width: 200px">
                    <div class="field_title">
                        <asp:Label ID="Label3" runat="server" Text="PO No In BPCS"/></div>
                    <div>
                        <asp:TextBox ID="BPCSPONoCtl" runat="server" Width="170px"  CssClass="InputTextReadOnly" ReadOnly="true"></asp:TextBox></div>
                </td>
    ...
    <div class="title"><asp:Label ID="Label2" runat="server" meta:resourcekey="Label_Title" /></div>
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" SelectMethod="GetPODetailByFormPOID" TypeName="BusinessObjects.FormPurchaseBLL">
        <SelectParameters>
