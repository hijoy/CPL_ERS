<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PVSpecialApproval.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_PVSpecialApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upDetails" runat="server">
        <ContentTemplate>
            <gc:GridView ID="gvDetails" runat="server" ShowFooter="True" CssClass="GridView"
                AutoGenerateColumns="False" DataKeyNames="FormPVDetailID" DataSourceID="odsDetails"
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" SelectMethod="GetPVDetailByFormPVID"
        TypeName="BusinessObjects.FormPurchaseBLL">
        <SelectParameters>
