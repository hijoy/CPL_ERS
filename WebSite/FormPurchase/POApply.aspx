<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="POApply.aspx.cs" Culture="Auto" UICulture="Auto" Inherits="FormPurchase_POApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="searchTable">
            ...
            <tr>
                ...
                <td style="width: 200px" valign="top">
                    <div class="field_title">
                        <asp:Label ID="Label_FormNoPR" runat="server" meta:resourcekey="Label_FormNoPR" />
                    </div>
                    <div style="margin-top: 5px">
                        <asp:HyperLink ID="FormNoCtl" runat="server"></asp:HyperLink></div>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: 400px">
                    ...
                    <div>
                        <asp:DropDownList ID="CompanyDDL" runat="server" DataSourceID="odsCompany" DataTextField="CompanyAddress" DataValueField="CompanyID" Width="370px" >
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="odsCompany" runat="server" ConnectionString="<%$ ConnectionStrings:ERSConnectionString %>"
                            SelectCommand="SELECT CompanyID, CompanyCode+'-'+CompanyAddress CompanyAddress FROM Company ">
                        </asp:SqlDataSource>
                    </div>
                </td>
                <td colspan="2" style="width: 400px">
    ...
    <asp:ObjectDataSource ID="odsDetails" runat="server" DeleteMethod="DeleteFormPODetailByID"
        ...
        InsertMethod="AddFormPODetail" UpdateMethod="UpdateFormPODetail" OnDeleting="odsDetails_Deleting">
        <DeleteParameters>
