...
namespace BusinessObjects {
    ...
    public class StuffUserBLL {
        ...
        public bool UpdateStuffUser(int StuffUserId, string StuffName, string StuffId, string UserName, string UserPassword, bool IsActive, string Telephone, string EMail, string EnglishName, DateTime AttendDate, int StaffLevelID, string VendorCode) {
        ...
        public int GetCompanyIDByPositionID(int PositionID) {
            if (this.StuffUserAdapter.GetCompanyIDByPositionID(PositionID) == null) {
                return 0;
            } else {
                return (int)this.StuffUserAdapter.GetCompanyIDByPositionID(PositionID);
            }
        }
