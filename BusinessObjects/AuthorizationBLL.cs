...
namespace BusinessObjects {
    ...
    public class AuthorizationBLL {
        ...
        private FlowParticipantConfigureTableAdapter m_FlowParticipantConfigureTA;

        public FlowParticipantConfigureTableAdapter FlowParticipantConfigureTA {
            get {
                if (this.m_FlowParticipantConfigureTA == null) {
                    this.m_FlowParticipantConfigureTA = new FlowParticipantConfigureTableAdapter();
                }
                return this.m_FlowParticipantConfigureTA;
            }
        }
        ...
        private StaffLevelTableAdapter m_StaffLevelTA;
        public StaffLevelTableAdapter StaffLevelTA {
            get {
                if (this.m_StaffLevelTA == null) {
                    this.m_StaffLevelTA = new StaffLevelTableAdapter();
                }
                return this.m_StaffLevelTA;
            }
        }

        private ProxyReimburseTableAdapter m_ProxyReimburseTableAdapter;
        public ProxyReimburseTableAdapter ProxyReimburseTA {
            get {
        ...
        public AuthorizationDS.StuffUserDataTable GetAllUser()
        {
            return this.StuffUserTA.GetData();
        }
        /// <summary>
        /// 获取用户
        /// </summary>
        ...
        public AuthorizationDS.StaffLevelRow GetStaffLevelById(int Id) {
            return this.StaffLevelTA.GetDataByID(Id)[0];
        }

        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
        public AuthorizationDS.StaffLevelDataTable GetStaffLevel() {

            return this.StaffLevelTA.GetData();
        }


        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public void InsertStaffLevel(string StaffLevelName, string Remark, bool IsActive, bool IsPlane) {
            this.StaffLevelTA.Insert(StaffLevelName, Remark, IsActive, IsPlane);
        }

        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, true)]
        public void UpdateStaffLevel(int StaffLevelID, string StaffLevelName, string Remark, bool IsActive, bool IsPlane) {
            AuthorizationDS.StaffLevelDataTable StaffLevelTab = this.StaffLevelTA.GetDataByStaffLevelID(StaffLevelID);
            AuthorizationDS.StaffLevelRow StaffLevelRow = StaffLevelTab[0];
            StaffLevelRow.StaffLevelName = StaffLevelName;
            StaffLevelRow.Remark = Remark;
            StaffLevelRow.IsActive = IsActive;
            StaffLevelRow.IsPlane = IsPlane;
            this.StaffLevelTA.Update(StaffLevelRow);
        }
        ...
        public BusinessObjects.AuthorizationDS.FlowParticipantConfigureDataTable GetFlowParticipantConfigure() {
            return this.FlowParticipantConfigureTA.GetData();
        }

        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public void InsertFlowParticipantConfigure(string FlowTemplateName, string FlowName, int FormTypeId) {
            AuthorizationDS.FlowParticipantConfigureDataTable tbFlow = new AuthorizationDS.FlowParticipantConfigureDataTable();
            AuthorizationDS.FlowParticipantConfigureRow rowFlow = tbFlow.NewFlowParticipantConfigureRow();

            rowFlow.FlowTemplateName = FlowTemplateName;
            rowFlow.FlowName = FlowName;
            rowFlow.FormTypeId = FormTypeId;

            tbFlow.AddFlowParticipantConfigureRow(rowFlow);
            FlowParticipantConfigureTA.Update(tbFlow);
        }

        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public void DeleteFlowParticipantConfigure(int FlowID) {
            SqlTransaction Transaction = null;
            try {
                Transaction = TableAdapterHelper.BeginTransaction(FlowParticipantConfigureTA);
                TableAdapterHelper.SetTransaction(FlowParticipantConfigureDetailTA, Transaction);

                FlowParticipantConfigureDetailTA.DeleteByFlowID(FlowID);
                FlowParticipantConfigureTA.DeleteByID(FlowID);
        ...
        //根据用户ID和业务实例ID得到流程模板
        public string GetFlowTemplateNameByFormTypeAndUserID(int FormTypeID, int UserID) {
            string FlowTemplate = string.Empty;
            AuthorizationDS.FlowParticipantConfigureDataTable table = FlowParticipantConfigureTA.GetFlowTemplateNameByFormTypeAndUserID(FormTypeID, UserID);
        ...
        public AuthorizationDS.ProxyReimburseDataTable GetProxyReimbursePaged(int startRowIndex, int maximumRows, string queryExpression, string sortExpression) {
            ...
            return this.ProxyReimburseTA.GetPagedData("ProxyReimburse", sortExpression, startRowIndex, maximumRows, queryExpression);
        }

        public void InsertProxyReimburse(int UserID, int ProxyUserID, DateTime EndDate) {

            AuthorizationDS.ProxyReimburseDataTable table = new AuthorizationDS.ProxyReimburseDataTable();
            AuthorizationDS.ProxyReimburseRow row = table.NewProxyReimburseRow();
            // 进行传值
            row.UserID = UserID;
            row.ProxyUserID = ProxyUserID;
            row.EndDate = EndDate;
            table.AddProxyReimburseRow(row);
            this.ProxyReimburseTA.Update(table);
        }

        public void DeleteProxyReimburseByID(int ID) {
            this.ProxyReimburseTA.DeleteByID(ID);
        }
        ...
        public int ProxyReimburseTotalCount(string queryExpression) {
            ...
            return (int)this.ProxyReimburseTA.QueryDataCount("ProxyReimburse", queryExpression);
        }

        public AuthorizationDS.ProxyReimburseRow GetProxyReimburseByID(int ID) {
            return this.ProxyReimburseTA.GetDataByID(ID)[0];
        }

        public AuthorizationDS.ProxyReimburseDataTable GetProxyReimburseByParameter(int UserID, int ProxyUserID, DateTime SubmitDate) {
            return this.ProxyReimburseTA.GetProxyDataByParameter(UserID, ProxyUserID, SubmitDate);
        }
