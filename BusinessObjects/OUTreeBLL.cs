...
namespace BusinessObjects {
    public class OUTreeBLL {
        ...
        /// <returns></returns>
        public AuthorizationDS.OrganizationUnitRow AddOrganizationUnit(string organizationUnitName, string organizationUnitCode, int? parentUnitId, int? organizationUnitTypeId,int? CostCenterID,string FlowParameter) {
            ...
            if (FlowParameter != null) {
                result.FlowParameter = FlowParameter;
            }
        ...
        /// <param name="organizationUnitTypeId"></param>
        /// <returns></returns>
        public AuthorizationDS.OrganizationUnitRow UpdateOrganizationUnit(int organizationUnitId, string ouName, string ouCode, int? organizationUnitTypeId, int? CostCenterID, string FlowParameter) {
            AuthorizationDS.OrganizationUnitRow ou = this.DS.OrganizationUnit.FindByOrganizationUnitId(organizationUnitId);
            ...
            if (FlowParameter != null) {
                ou.FlowParameter = FlowParameter;
            }
            this.OrganizationUnitTA.Update(ou);
            return ou;
        }
        ...
        /// <returns></returns>
        public AuthorizationDS.PositionRow AddPosition(string positionName,int flowLevel,bool isManager, int organizationUnitId, List<int> positionTypeIds) {
        ...
        /// <param name="positionTypeIds"></param>
        /// <returns></returns>
        public AuthorizationDS.PositionRow UpdatePosition(int positionId, string positionName, int flowLevel, bool isManager, List<int> positionTypeIds) {
            AuthorizationDS.PositionRow position = DS.Position.FindByPositionId(positionId);
            position.PositionName = positionName;
            position.FlowLevel = flowLevel;
            position.IsManager = isManager;
        ...
        public AuthorizationDS.PositionDataTable GetPositionsByID(int PositionID) {
            return PositionTA.GetDataById(PositionID);
        }
        ...
        /// <summary>
        /// 根据OrganizationUnitId获取FlowParameter
        /// </summary>
        /// <param name="OrganizationUnitId"></param>
        /// <returns></returns>
        public string GetFlowParameter(int OrganizationUnitId)
        {
            AuthorizationDS.OrganizationUnitRow l_drOrganizationUnit = GetOrganizationUnitById(OrganizationUnitId);
            if (string.IsNullOrEmpty(l_drOrganizationUnit.FlowParameter))
            {
                return GetFlowParameter(l_drOrganizationUnit.ParentOrganizationUnitId);
            }
            return l_drOrganizationUnit.FlowParameter;
